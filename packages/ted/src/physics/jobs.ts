...
import type { TPhysicsJobContext, TRunJobConfig } from '../jobs/jobs';
import type {
...
export const PhysicsJobQueryLine: TRunJobConfig<
  {
    from: vec3;
    to: vec3;
...
export const PhysicsJobQueryArea: TRunJobConfig<
  {
    from: vec3;
    to: vec3;
    options?: TPhysicsQueryOptions;
...
export const PhysicsJobCreateWorld: TRunJobConfig<TWorldConfig, void> = {
  name: 'create_world',
  requiredContext: TJobContextTypes.Physics,
};

export const PhysicsJobSimulateStep: TRunJobConfig<
  {
    delta: number;
...
export function registerPhysicsJobs(jobManager: TJobManager) {
  ...
  jobManager.registerJob<TPhysicsJobContext, TWorldConfig, void>(
